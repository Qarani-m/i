...
FONT_PATH = 'assets/font/FREAKSOFNATUREMASSIVE-1.ttf'
...
if os.path.exists("status.txt"):
    ...
    print("File 'status.txt' does not exist.")

# Add a delay to avoid constant checking (optional)
time.sleep(1)


ANIM_TIME_INTERVAL = 1500000
